...
/**
 * Description of Tbl_c_source_code_assessments
 *
 * @author User
 */
class Tbl_c_source_code_assessments extends MY_Model {

    //put your code here  
    public static $table_name = "tbl_c_source_code_assessments";
