...
class TypeController extends Controller {
    ...
    //put your code here
    protected $MY_Model;
    protected $table_default = 'tbl_a_project_types';
    ...
    public function create(Request $request) {
        ...
        $_config = [
            'title_for_header' => 'Create new <b>Type</b> master data project page',
            'create_page' => [
                'title' => 'click to open type list page',
    ...
    public function edit(Request $request, $pr_id = null) {
        ...
        $_config = [
            'title_for_header' => 'Update <b>Type</b> master data project page',
            'create_page' => [
        ...
        $type = $this->MY_Model->find($request, 'first', $params, 'mysql_assessment');
        return view('Public_html.Layouts.Adminlte.dashboard', compact('title_for_layout', '_breadcrumbs', '_config', 'type'));
    }
    ...
    public function view(Request $request) {
        ...
        $_config = [
            'title_for_header' => '<b>Type</b> master data project page',
            'create_page' => [
