...
use App\Models\Tables\Assessment\Tbl_a_project_types;
...
class TypeController extends Controller {
    ...
    public function get_list(Request $request) {
        if (isset($request) && !empty($request)) {
            ...
            if (isset($search) && !empty($search)) {
                $data = DB::connection('mysql_assessment')->table('tbl_a_project_types AS a')
                        ->where('a.id', '=', $search)
                        ...
                        ->limit($limit)
                        ->get();
                $total_rows = DB::connection('mysql_assessment')->table('tbl_a_project_types AS a')->where('a.id', '=', $search)
                ...
                $data = DB::connection('mysql_assessment')->table('tbl_a_project_types AS a')
                        ...
                        ->limit($limit)
                        ->get();
                $total_rows = DB::connection('mysql_assessment')->table('tbl_a_project_types AS a')->count();
            }
    ...
    public function insert(Request $request) {
        ...
        if (isset($data) && !empty($data)) {
            ...
            $response = DB::connection('mysql_assessment')->table('tbl_a_project_types')->insert($param);
            if ($response) {
    ...
    public function update(Request $request, $pr_id = null) {
        ...
        if (isset($data) && !empty($data)) {
            ...
            $response = DB::connection('mysql_assessment')->table('tbl_a_project_types')->where('id', '=', (int) $id)->update($update_data);
            if ($response) {
