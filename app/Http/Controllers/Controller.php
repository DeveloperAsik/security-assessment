...
class Controller extends BaseController {
    ...
    public function __construct(Request $request) {
        ...
        //else {
        //    $this->__is_logged_in = true;
        //    $this->__user_id = 2;
        //    $this->__group_id = 2;
        //    $this->__user_name = 'superuser';
        //    $this->__user_email = 'super.user@mail.com';
        //}
    ...
    public function init_global_var($request) {
        ...
        if (isset($this->__user_id) && !empty($this->__user_id)) {
            $user_detail = Tbl_a_users::get_by_id($this->__user_id);

            $user_detail_date = MyHelper::fnDateDiff(MyHelper::getDateNow(), $user_detail->updated_date, false, true);
            $user_log = Tbl_d_logs::get_by($request, array(
                        'conditions' => [
            ...
            $user_log_date = MyHelper::fnDateDiff(MyHelper::getDateNow(), $user_log->updated_date, false, true);
        }
        $_menu_profiles = [
            [
                'id' => 1,
        ...
        if (isset($this->__user_id) && !empty($this->__user_id)) {
            $sidebar_menu = Tbl_a_menus::get_tree_menu($request, $this->__group_id, $module_id);
