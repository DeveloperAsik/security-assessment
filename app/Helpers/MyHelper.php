...
class MyHelper {
    ...
    public static function fnDateDiff($date_1, $date_2, $getSecond = false, $getDetailDate = false) {
        ...
        if ($getDetailDate == false) {
            ...
            $res = MyHelper::getDetailDate($times);
        }
        return $res;
    }

    public static function getDetailDate($param = null, $options = []) {
        if ($param != null) {
            $str = '';
            if ($param['month'] > 0) {
