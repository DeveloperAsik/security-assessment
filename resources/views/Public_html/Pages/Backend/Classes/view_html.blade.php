                ...
                <div class="card" style="background-color:#fff; color:#000">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="/extraweb/classes/create" class="btn btn-success btn-sm" title="Click this button to add new classes!">
                    ...
                    <div class="card-table">
                        <div class="table-responsive-sm p-3">
                            <table style="width:100%;background-color:#fff;color:#000; font-size:10px;" class="table table-bordered" id="classes">
                                <thead>
