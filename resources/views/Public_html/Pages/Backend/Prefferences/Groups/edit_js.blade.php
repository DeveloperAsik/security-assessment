        ...
        return {
            ...
            init: function () {
                ...
                $('input[name="check"][value="is_active"').on('click', function (e) {
                    ...
                    var uri = _base_extraweb_uri + '/prefferences/group/update/' + Base64.encode($(this).attr('data-id'));
                    var type = 'POST';
                    var formdata = {
                ...
                $('#submit_form_edit').on('click', function (e) {
                    e.preventDefault();
                    var uri = _base_extraweb_uri + '/prefferences/group/update/' + Base64.encode($('input[name="id"]').val());
                    var type = 'POST';
                    var formdata = {
