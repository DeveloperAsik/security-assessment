                                ...
                                <form class="form-horizontal">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control user_multiselect" id="user_id" name="user_id" multiple="multiple">
                                                    @if(isset($users) && !empty($users))
                                                    @foreach($users AS $keyword => $value)
                                                    <option value="{{$value->user_id}}">{!! $value->user_id . " - " . $value->user_name . " <small>( " . $value->email . " )</small>" !!}</option>
                                                    @endforeach
                                                    @endif
                                                </select>
                                            </div>
