                ...
                <div class="card" style="background-color:#fff; color:#000">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{config('app.base_extraweb_uri')}}/prefferences/user/auth/create" class="btn btn-success btn-sm" title="Click this button to add new group permission!">
