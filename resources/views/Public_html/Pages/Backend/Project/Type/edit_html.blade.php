                                ...
                                <form class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" value="{{$project_types->name}}" name="name" class="form-control" id="name" placeholder="title">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="description" class="col-sm-2 control-label">description</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control" name="description" id="description" name="description" >{{$project_types->description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="is_active" class="col-sm-2 control-label">Is Active</label>
                                            <div class="col-sm-10">
                                                @if($project_types->is_active == 1)
                                                    @php $checked = ' checked'; @endphp
                                                @else
                                                    @php $checked = '';@endphp
                                                @endif
                                                <input type="checkbox" name="check" data-id="{{ base64_encode($project_types->id)}}" value="is_active"{{$checked}}> 
                                            </div>
                                        </div>
                                        @endif
                                    </div>
