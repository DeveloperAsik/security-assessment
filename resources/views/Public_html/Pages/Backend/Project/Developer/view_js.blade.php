    ...
    var ViewJS = function () {
        return {
            ...
            init: function () {
                ...
                var table = $('#project_team_developer').DataTable({
                    ...
                    "ajax": {
                        url: _base_extraweb_uri + '/project/developer-teams/get_list',
                        headers: {
                ...
                $('#project_team_developer').on('click', 'input[type="checkbox"][name="is_active"]', function (e) {
                    loadingImg('img-loading', 'start');
                    var checked = this.checked;
                    var uri = _base_extraweb_uri + '/project/developer-teams/update/' + $(this).attr('data-id');
                    var type = 'POST';
                    var formdata = {
